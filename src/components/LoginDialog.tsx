...
export default function LoginDialog({ open, onOpenChange, onGuestMode }: LoginDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader className="space-y-3 text-center">
          ...
          <DialogTitle className="text-2xl">智汇南洋</DialogTitle>
          <DialogDescription>商务英语沉浸式学习平台</DialogDescription>
        </DialogHeader>
