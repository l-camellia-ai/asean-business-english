...
智汇南洋是一个专为中国-东盟商务场景设计的沉浸式英语学习平台。整合AI情景对话、商务知识库、游戏化学习与数字人对话等核心功能，通过东盟市场地图可视化、六维能力雷达图、游戏化激励系统等特色功能，全面提升跨文化商务交际能力。

### 核心功能

- **情景实战**：AI情景对话工坊、AI电话工坊、标准化情景模块训练
- **商务知识库**：国别商务文化指南、行业术语与实务库、动态政策与市场洞察
- **学习社区**：个人成长展示墙、多维激励排行榜、专家问答
- **企业服务**：团队管理后台、能力诊断报告、定制化方案管理
- **学习地图**：东盟10国市场开拓地图可视化、六维能力雷达图
- **每日挑战**：游戏化激励、签到任务、限时挑战、连胜奖励
- **AI实训增强包**：订阅套餐管理、无限次AI评分、深度评测报告
- **个人中心**：个人信息、学习设置、订阅管理、企业绑定

### 覆盖范围

覆盖东盟10国：泰国、越南、印尼、新加坡、马来西亚、菲律宾、文莱、柬埔寨、老挝、缅甸
